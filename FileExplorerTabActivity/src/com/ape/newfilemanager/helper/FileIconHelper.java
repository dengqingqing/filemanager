...
import com.ape.newfilemanager.helper.FileIconLoader.IconLoadFinishListener;
...
//        }, R.drawable.file_icon_office);
        addItem(new String[] {"doc"},  R.drawable.file_icon_office_doc);
        addItem(new String[] {"docx"}, R.drawable.file_icon_office_docx);
        addItem(new String[] {"xls"},  R.drawable.file_icon_office_xls);
        addItem(new String[] {"xlsx"}, R.drawable.file_icon_office_xlsx);
        addItem(new String[] {"ppt"},  R.drawable.file_icon_office_ppt);
        addItem(new String[] {"pptx"}, R.drawable.file_icon_office_pptx);
