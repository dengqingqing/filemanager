...
public class FileIconLoader implements Callback {
    ...
    public static class FileId {
        ...
        public FileId(String path, long id, FileCategory cate, ImageView iconView) {
            mPath = path;
            mId = id;
            mCategory = cate;
            mIconView = iconView;
    ...
    public boolean loadIcon(ImageView view, String path, long id, FileCategory cate) {
        ...
        if (loaded) {
            ...
            FileId p = new FileId(path, id, cate, view);
    ...
    private class LoaderThread extends HandlerThread implements Callback {
        ...
        public boolean handleMessage(Message msg) {
            ...
            int width = mContext.getResources().getDimensionPixelSize(R.dimen.file_list_item_icon_width);
            int height = mContext.getResources().getDimensionPixelSize(R.dimen.file_list_item_icon_height);
            while (iterator.hasNext()) {
                ...
                if (holder != null && holder.state == ImageHolder.NEEDED) {
                    ...
                    switch (id.mCategory) {
                        case Apk:
                            ...
                            holder.state = BitmapHolder.LOADED; //(icon != null) ? BitmapHolder.LOADED : BitmapHolder.NEEDED;
                            break;
                        case Picture:
                        case Video:
