...
public class RemoteManagerFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootView = inflater.inflate(R.layout.remote_manager_fragment,
				container, false);
	...
	public void updateUi() {
		...
		if (isWifiReady) {
			...
			/*
			 * startStopButtonText
			 * .setCompoundDrawablesWithIntrinsicBounds(running ?
			 * R.drawable.disconnect : R.drawable.connect, 0, 0, 0);
			 */
			startStopButtonText.setTextColor(running ? getResources().getColor(
					R.color.remote_manager_conect_color) : getResources()
					.getColor(R.color.remote_manager_disconect_color));
		} else {
