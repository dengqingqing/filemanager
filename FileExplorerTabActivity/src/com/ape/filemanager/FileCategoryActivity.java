...
//        }
    ...
    public void refreshCategoryInfo() {
        ...
        SDCardInfo sdCardInfo = Util.getSDCardInfoFromPaths(mActivity, mMountPointManager.getMountPointPaths());
        if (sdCardInfo != null) {
...
//            setCategoryBarValue(FileCategory.Other, otherSize);
            setCategorySize(FileCategory.app_MM, otherSize);
            setCategoryBarValue(FileCategory.app_MM, otherSize);
        }
