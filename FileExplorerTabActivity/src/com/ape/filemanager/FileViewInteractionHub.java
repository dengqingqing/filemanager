...
//        }
    ...
    private void updateNavigationPane() {
        ...
        //Add by yinglong.tang begin
        String tmpString = mFileViewListener.getDisplayPath(mCurrentPath);
        //Log.v(LOG_TAG, "tmpString :" + tmpString );
        //boolean storageRemovable = Environment.isExternalStorageRemovable();
        //boolean storageEmulated = Environment.isExternalStorageEmulated();
        //Log.v(LOG_TAG, "storageRemovable :" + storageRemovable + ", storageEmulated = " + storageEmulated);
        ...
        //Add by yinglong.tang end
        mNavigationBarText.setText(tmpString);//Modified by yinglong.tang.   mFileViewListener.getDisplayPath(mCurrentPath)
    }
    ...
    public void onOperationSend() {
        ...
        if (((FileExplorerTabActivity) mContext).getActionMode() == null) //STGOO-650
        {
            clearSelection();
        }
    }
